...
<style>
    ...
    .header-bg {
        background-image: url("{{ asset('storage/category/images/'.$category->images) }}");
        height: 479px;
...
<div class="header-bg"
    ...
    <div class="display-table  center-text">
        <h1 class="title display-table-cell"><b>{{ Str::upper($category->name)  }}</b></h1>
    </div>
</div>
...
<section class="recomended-area section">
    <div class="container">
        <div class="row">
            ...
            @endforeach
            @else
            <H2 class="text-danger "><strong>Sorry! This category have no post</strong></H2>
            @endif
